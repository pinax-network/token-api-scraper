-- ============================================================================
-- ERC20 Balances RPC Table
-- Stores ERC20 token balances fetched from smart contracts via RPC calls
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS erc20_balances_rpc (
    ...
    block_num UInt32 DEFAULT 0 COMMENT 'Block number from erc20_transfer that triggered this balance query',
...
COMMENT 'ERC20 token balances fetched from smart contracts via RPC calls';
...
-- Stores native token balances fetched from RPC calls
-- ============================================================================
...
ENGINE = ReplacingMergeTree(last_update)
ORDER BY (account)
COMMENT 'Native token balances fetched from RPC calls';
